...
<keywordspec name="RPA.HTTP" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-05-17T07:09:37+00:00" specversion="5" source="./RPA/HTTP.py" lineno="71">
...
<arguments repr="alias, url, headers={}, cookies={}, client_certs=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'TRACE', 'GET']">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'TRACE', 'GET']">
<name>retry_method_list</name>
<default>['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'TRACE', 'GET']</default>
</arg>
</arguments>
...
<arguments repr="alias, url, auth, headers={}, cookies={}, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'TRACE', 'GET']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<arguments repr="alias, url, headers={}, cookies={}, auth=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'TRACE', 'GET']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
